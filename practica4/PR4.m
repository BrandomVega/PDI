...
num = input("Ingrese numero de puntos a clasificar: ");
c1x=randi([1,1280],1,num);
c1y=randi([1,250],1,num);

c2x=randi([1,1280],1,num);
c2y=randi([250,505],1,num);

c3x=randi([1,1280],1,num);
c3y=randi([510,768],1,num);
